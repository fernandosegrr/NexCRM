...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "mt-auto flex flex-col gap-2 border-t border-border p-6 sm:flex-row sm:justify-end",
      className,
    )}
    {...props}
  />
